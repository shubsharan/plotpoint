import { deleteStory } from "@plotpoint/db";
...
const deleteStoryResponseSchema = z.object({
...
export const deleteStoryRoute = new Hono();

deleteStoryRoute.delete("/stories/:id", async (context) => {
