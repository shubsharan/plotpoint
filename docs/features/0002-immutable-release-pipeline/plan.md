...
- [Unversioned Contract Names](../../adrs/0006-unversioned-contract-names.md) - **Accepted**. Governs plain public symbols, semantic identifiers, and centralized serialized compatibility metadata.
