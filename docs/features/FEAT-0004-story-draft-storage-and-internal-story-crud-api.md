...
- [ ] Draft storage reuses the FEAT-0003 bundle contract without redefining story content shapes.
...
- Risk: draft storage diverges from the canonical bundle contract. Mitigation: reuse FEAT-0003 shapes directly and avoid a second draft-content schema.
