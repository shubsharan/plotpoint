...
content whose required schema is exactly that schema ID and version. When absent, the canonical
...
outside the selected mechanic, invalid component dependencies, catalog/registry/inventory disagreement,
or capability-union/manifest disagreement.
