...
3. Host API Shared Play and Sync use game-neutral, schema-identified envelopes for command
...
9. Capability observations may cross the configured HTTPS boundary and contribute to the canonical
   ...
   projections, logs, operational events, and reports unless a future centrally governed contract
   explicitly permits retention. Mechanic adapters may derive only the redacted facts their declared
   projections require.
